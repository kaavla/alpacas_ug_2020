...
public class shankAugmentedDrive extends LinearOpMode {
    ...
    Vector2d targetAVector = new Vector2d(-12, -51);
    // The heading we want the bot to end on for targetA
    double targetAHeading = Math.toRadians(165);

    // The location we want the bot to automatically go to when we press the B button
    Vector2d targetBVector = new Vector2d(-24, -36);
