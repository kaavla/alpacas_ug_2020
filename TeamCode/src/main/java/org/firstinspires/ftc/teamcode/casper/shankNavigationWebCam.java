...
@TeleOp(name="SHANK-1 Vuforia Nav Webcam", group ="Concept")
//@Disabled
public class shankNavigationWebCam extends LinearOpMode {
    ...
    private static final float remoteWallBlue  = 24 * mmPerInch;
    ...
    @Override public void runOpMode() {
        ...
        //
        // For a WebCam, the default starting orientation of the camera is
        // looking UP (pointing in the Z direction),
        // with the wide (horizontal) axis of the camera aligned with the X axis, and
        // the Narrow (vertical) axis of the camera aligned with the Y axis
        //
        // But, this example assumes that the camera is actually facing forward
        // out the front of the robot.
        // So, the "default" camera position requires two rotations
        // to get it oriented correctly.
        // 1) First it must be rotated +90 degrees around the X axis to get it horizontal
        // (it's now facing out the right side of the robot)
        // 2) Next it must be be rotated +90 degrees (counter-clockwise)
        // around the Z axis to face forward.
        //
        // Finally the camera can be translated to its actual mounting position on the robot.
        //      In this example, it is centered (left to right),
        //      but 4" forward of the middle of the robot, and 8" above ground level.
